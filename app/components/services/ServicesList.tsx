...
const ServiceItem: React.FC<ServiceItemProps> = ({ title, description }) => {
  return (
    <div
      className="flex items-center justify-between py-10 md:py-12 px-2 md:px-8
...
const ServicesList: React.FC = () => {
  ...
  return (
    <div className=" bg-transparent text-white  px-2 md:px-6 absolute  top-32 md:top-80  w-full">
